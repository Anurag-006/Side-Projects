...
const SnakeContextProvider = ({ children }: any) => {
  ...
  return (
    <SnakeContext.Provider value={{ snakeArr, setSnakeArr, axis, oldAxis, setAxis, setOldAxis, snakeHead, setSnakeHead, snakeFood, setSnakeFood, isGameOver, setIsGameOver, score, setScore }}>
      {children}
